...
var UIController = (function () {
    ...
    var DOMstrings = {
        ...
        percentageExp: '.budget__expenses--percentage',
    ...
    return {
        ...
        clearFields: function () {
           ...
           fields = Array.from(document.querySelectorAll(DOMstrings.inputDescript + ', ' + DOMstrings.inputValue));
        ...
        displayBudget: function (obj) {
          ...
          document.querySelector(DOMstrings.budget).textContent = formatNumber(type, obj.budget);
          document.querySelector(DOMstrings.income).textContent = formatNumber('inc', obj.totalInc);
          document.querySelector(DOMstrings.expense).textContent = formatNumber('exp', obj.totalExp);
          
          if(obj.percentage > 0){
            document.querySelector(DOMstrings.percentageExp).textContent = obj.percentage + '%';
          }else{
            document.querySelector(DOMstrings.percentageExp).textContent = '--';
          }
        },

        displayPercentages: function (percentages) {
          var percent = document.querySelectorAll(DOMstrings.percentages); 

          nodeListForEach(percent, function (curr, index) {
...
var controller = (function (budgetCtrl, uiCtrl) { 
    ...
    var setupEventListener = function () {
        ...
        document.querySelector(DOM.delegateEvent).addEventListener('click', ctrlDeleteItem);
    ...
    var ctrlAddItem = function () {
      ...
      var ctrlDeleteItem = function (event) {
        ...
        if(itemID){
           ...
           //dlete the item from data 
          budgetCtrl.deleteItem(type, ID);

           //dlete the item from ui
